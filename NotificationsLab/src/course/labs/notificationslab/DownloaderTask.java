		...
		mApplicationContext.sendOrderedBroadcast(new Intent(
				...
				new BroadcastReceiver() {
					...
					public void onReceive(Context context, Intent intent) {
						...
						// TODO: Check whether the result code is not
						...
						if (getResultCode() != MainActivity.IS_ALIVE) {
							...
							NotificationManager manager = (NotificationManager) mApplicationContext
									.getSystemService(mApplicationContext.NOTIFICATION_SERVICE);
